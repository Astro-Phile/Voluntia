  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        teal: "bg-teal-green text-white hover:bg-teal-green/90 shadow-card hover:shadow-elevated",
        coral: "bg-soft-coral text-white hover:bg-soft-coral/90 shadow-card hover:shadow-elevated", 
        yellow: "bg-sunrise-yellow text-graphite-gray hover:bg-sunrise-yellow/90 shadow-card hover:shadow-elevated",
        orange: "bg-alert-orange text-white hover:bg-alert-orange/90 shadow-card hover:shadow-elevated",
